...
Once it's running, head to [http://127.0.0.1:8000/docs](http://127.0.0.1:8000/docs) — that's the interactive Swagger UI, and honestly it's the easiest way to poke around and see what this thing can do without writing any client code.
